  ...
  */
  register_post_type( 'speakers', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
    ...
    */
    array(
      'labels' => array(
        'name'                => __( 'Speakers', 'post type general name' ), /* This is the Title of the Group */
        'singular_name'       => __( 'Speaker', 'post type singular name' ), /* This is the individual type */
        'add_new'             => __( 'Add New', 'custom post type item' ), /* The add new menu item */
        'add_new_item'        => __( 'Add New Speaker' ), /* Add New Display Title */
        'edit'                => __( 'Edit' ), /* Edit Dialog */
        'edit_item'           => __( 'Edit Speaker' ), /* Edit Display Title */
        'new_item'            => __( 'New Speaker' ), /* New Display Title */
        'view_item'           => __( 'View Speaker' ), /* View Display Title */
        'search_items'        => __( 'Search Speakers' ), /* Search Custom Type Title */
